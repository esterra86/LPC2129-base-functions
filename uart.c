...
void UART_InitWithInt(unsigned int uiBaudRate){
   ...
   U0IER  |= mRX_DATA_AVALIABLE_INTERRUPT_ENABLE;               // przerwanie w uart moze pochodzic z 4 zrodel
	//w tym przypadku wlaczamy mozliwosc odbierania przerwan z RBR. flaga zapala sie gdy w rbr znajduja sie odebrane dane
